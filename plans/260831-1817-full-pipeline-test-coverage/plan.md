...
và fault injection; không thay đổi product contract hoặc triển khai application feature mới.
...
None. Dùng contract hiện tại và biến mọi limitation đã biết thành expected residual có test/documentation,
